    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        plusButton.setOnClickListener {
            ...
            if (isPlusButtonClicked) {
                ...
                plusButton.backgroundTintList = ContextCompat.getColorStateList(this, R.color.nav_icon_color) // 원래 색상으로 변경
...
//    }
    ...
    private fun showMatchingDialog(plusButton: FloatingActionButton) {
        ...
        alertDialog.setOnDismissListener {
            ...
            plusButton.backgroundTintList = ContextCompat.getColorStateList(this, R.color.nav_icon_color)
